const settingsPaymentPixRede = window.wc.wcSettings.getSetting('lkn_rede_pix_for_woocommerce_data', {})
const labelPaymentPixRede = window.wp.htmlEntities.decodeEntities(settingsPaymentPixRede.title)

const showButtonRede = settingsPaymentPixRede.show_button === 'yes'
const ContentPaymentPixRede = props => {
    const { onSubmit } = props;

    return /* #__PURE__ */ React.createElement('div', {},
    /* #__PURE__ */React.createElement('div', {
        class: 'LknPaymentPixForWoocommerceRedePixFields'
    }, /* #__PURE__ */React.createElement('p', null, settingsPaymentPixRede.description), /* #__PURE__ */React.createElement('svg', {
        id: 'payment-logo-rede',
        ...
        showButtonRede && React.createElement('div', {
...
const BlockGatewayPaymentPixRede = {
    name: 'lkn_rede_pix_for_woocommerce',
    label: labelPaymentPixRede,
    content: window.wp.element.createElement(ContentPaymentPixRede),
    edit: window.wp.element.createElement(ContentPaymentPixRede),
    canMakePayment: () => true,
    ariaLabel: labelPaymentPixRede,
    supports: {
        features: settingsPaymentPixRede.supports
    }
}
window.wc.wcBlocksRegistry.registerPaymentMethod(BlockGatewayPaymentPixRede)
