...
const ExtensionPicker = observer((props) => {
	...
	const [extensions, setExtensions] = React.useState([
		...
		},
		{
			checked: false,
			extension: ".pps",
			value: "application/mspowerpoint,application/vnd.ms-powerpoint",
			category: "documents",
		},
		{
			checked: false,
		...
		},
		{
			checked: false,
			extension: ".mp3",
			value: "audio/mpeg3,audio/x-mpeg-3,video/mpeg,video/x-mpeg",
			category: "audio",
		},
		{
			checked: false,
		...
		},
		{
			checked: false,
			extension: ".wmv",
			value: "video/x-ms-asf,video/x-ms-wmv",
			category: "video",
		},
		{
			checked: false,
		...
		},
		{
			checked: false,
			extension: ".3gp",
			value: "video/3gpp,audio/3gpp",
			category: "video",
		},
		{
			checked: false,
			extension: ".3g2",
			value: "video/3gpp2,audio/3gpp2",
			category: "video",
		},
		{
			checked: false,
	...
	React.useEffect(() => {
		let currentValue = store._FIELD_COMPONENTS_.getPropertyValue(
		...
		<React.Fragment>
			<If condition={simple}>
				<Box className={classes.checkboxContainer}>
					<InputLabel shrink>{props.field.label}</InputLabel>
					<FormGroup row>
						<FormControlLabel
							style={{ width: "80%" }}
							control={
					...
					<input
						type="hidden"
						value={store._FIELD_COMPONENTS_.getPropertyValue(
							store._UI_.activeFormFieldInSidebar,
							props.field.id
						)}
					/>
